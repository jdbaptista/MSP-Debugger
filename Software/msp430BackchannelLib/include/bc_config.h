...
#define BC_INT_VEC USCIAB0TX_VECTOR
#define BCCTL0 UCA0CTL0
#define BCCTL1 UCA0CTL1
#define BCBR0 UCA0BR0
#define BCBR1 UCA0BR1
#define BCMCTL UCA0MCTL
#define BCSTAT UCA0STAT
#define BCRXBUF UCA0RXBUF
#define BCTXBUF UCA0TXBUF
#define BCABCTL UCA0ABCTL
#define BCIRTCTL UCA0IRTCTL
#define BCIRRCTL UCA0IRRCTL
#define BCIE IE2
#define BCIFG IFG2
#endif
